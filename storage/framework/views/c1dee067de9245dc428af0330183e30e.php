                                ...
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13">
                                            <i class="bx bxs-up-arrow align-middle"></i>$34 Since
                                            last week
                                        </p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13">
                                            <i class="bx bxs-up-arrow align-middle"></i>14% Since
                                            last week
                                        </p>
                                    </div>
                                    <div class="widgets-icons ms-auto">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13">
                                            <i class="bx bxs-down-arrow align-middle"></i>12.4%
                                            Since last week
                                        </p>
                                    </div>
                                    <div class="widgets-icons ms-auto">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <img src="assets/images/avatars/avatar-1.png"
                                                                class="rounded-circle" width="46"
                                                                height="46" alt="" />
                                                        </div>
                                                        <div class="ms-2">
                                                            <h6 class="mb-1 font-14">
                                                                Payment from Michle Jhon
                                                            </h6>
                        ...
                        <div class="card radius-10 w-100">
                            ...
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    Kids
                                    <span class="badge bg-light-white-2 rounded-pill">25</span>
                                </li>
                                <li
                                    class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    Women
                                    <span class="badge bg-light-white-3 rounded-pill">10</span>
                                </li>
                                <li
                                    class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    Men
                                    <span class="badge bg-white rounded-pill text-dark">65</span>
                                </li>
                                <li
                                    class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    Furniture
                                    <span class="badge bg-light-white-4 text-white rounded-pill">14</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card radius-10 w-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <p class="mb-0 align-self-center font-weight-bold ms-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u407959809/domains/realestate.codefixxer.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>