    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div class="text-center mb-40">
                <a href="<?php echo e(url('/')); ?>" class="max-w-290-px d-inline-block">
            ...
            <form id="loginForm" action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="row mb-32">
                    <div class="col-6">
                        <a href="<?php echo e(route('google.login')); ?>" class="btn text-primary-600 border d-flex align-items-center justify-content-center w-100 gap-2">
                            <iconify-icon icon="logos:google-icon" class="text-xl"></iconify-icon>
                            Google
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('facebook.login')); ?>" class="btn text-primary-600 border d-flex align-items-center justify-content-center w-100 gap-2">
                ...
                <p class="text-center text-sm mb-0">
                    ...
                    <a href="<?php echo e(route('registerform')); ?>" class="text-primary-600 fw-semibold">Sign Up</a>
                </p>
            </form>
        </div>
    </div>
...
<!-- Popup -->
<script src="<?php echo e(asset('assets/js/lib/magnific-popup.min.js')); ?>"></script>
<!-- Slick Slider -->
...
<?php /**PATH /Applications/XAMPP/htdocs/casino/resources/views/auth/login.blade.php ENDPATH**/ ?>