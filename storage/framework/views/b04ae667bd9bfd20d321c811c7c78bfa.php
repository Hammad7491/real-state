...
<div class="container my-5">
  <div class="card shadow border-0 rounded-3">
    <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
      ...
      <a href="<?php echo e(route('admin.roles.create')); ?>" class="btn btn-light-primary btn-sm d-flex align-items-center">
            ...
            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <?php $__currentLoopData = $role->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.permissions.show', $permission)); ?>"
                       ...
                       title="View/Edit <?php echo e(ucfirst($permission->name)); ?>">
                ...
                <td class="text-center">
                  <a href="<?php echo e(route('admin.roles.show', $role)); ?>" class="btn btn-sm btn-outline-secondary me-1" title="View">
                    <i class="bx bx-show"></i>
                  </a>
                  <a href="<?php echo e(route('admin.roles.edit', $role)); ?>" class="btn btn-sm btn-outline-primary me-1" title="Edit">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/htdocs/real-estate/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>